...
Route::match(['get', 'post'], 'translate', [\App\Http\Controllers\TranslateController::class, 'index'])->name('translate');
// Route::get('translate', [\App\Http\Controllers\TranslateController::class, 'index'])->name('translate');
// Route::post('translate', [\App\Http\Controllers\TranslateController::class, 'index'])->name('translate.translate');
